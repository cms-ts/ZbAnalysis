...
while [ $i -le 2 ]; do
  ...
  root -l -q -b DataMCComp.C\(\"w_invMass_mm\",1,$i\)
  root -l -q -b DataMCComp.C\(\"w_invMass_ee\",1,$i\)
...
# root -l -q -b DataMCComp.C\(\"b_ee_inv\",1,$i\)
  ...
  root -l -q -b DataMCComp.C\(\"w_Z_pt_ee\",1,$i\)
  root -l -q -b DataMCComp.C\(\"w_Z_pt_mm\",1,$i\)
  root -l -q -b DataMCComp.C\(\"b_pt_Z_ee\",1,$i\)
  root -l -q -b DataMCComp.C\(\"b_pt_Z_mm\",1,$i\) 
...
# root -l -q -b DataMCComp.C\(\"b_invMass_mm\",1,$i\)
  ...
  root -l -q -b DataMCComp.C\(\"w_invMass_mm_b\",1,$i\)
  root -l -q -b DataMCComp.C\(\"w_invMass_ee_b\",1,$i\)
...
while [ $i -le 2 ]; do
  ...
  root -l -q -b DataMCComp.C\(\"SVTX_mass\",1,$i,0,2\)
  root -l -q -b DataMCComp.C\(\"SVTX_mass\",1,$i,1,2\)
