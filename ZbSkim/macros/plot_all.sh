...
root -l -q -b DataMCComp.C\($d,\"w_MET\",1,3,0,1\)
root -l -q -b DataMCComp.C\($d,\"w_MET_b\",1,3,0,1\)
...
root -l -q -b DataMCComp.C\($d,\"w_mass_em_wide\",1,3\)

root -l -q -b DataMCComp.C\($d,\"w_mass_em_b_wide\",1,3\)

root -l -q -b DataMCComp.C\($d,\"w_mass_em\",1,3\)
root -l -q -b DataMCComp.C\($d,\"w_pt_Z_em\",1,3\)
root -l -q -b DataMCComp.C\($d,\"w_delta_phi_em\",1,3\)

root -l -q -b DataMCComp.C\($d,\"w_mass_em_b\",1,3\)
root -l -q -b DataMCComp.C\($d,\"w_pt_Z_em_b\",1,3\)
root -l -q -b DataMCComp.C\($d,\"w_delta_phi_em_b\",1,3\)

root -l -q -b DataMCComp.C\($d,\"w_jetmultiplicity\",1,3\)
root -l -q -b DataMCComp.C\($d,\"w_first_jet_pt\",1,3\)
root -l -q -b DataMCComp.C\($d,\"w_first_jet_eta\",1,3\)

root -l -q -b DataMCComp.C\($d,\"w_single_pt_Z_em_b\",1,3\)
...
root -l -q -b DataMCComp.C\($d,\"w_third_jet_pt\",1,3\)
root -l -q -b DataMCComp.C\($d,\"w_third_jet_eta\",1,3\)

root -l -q -b DataMCComp.C\($d,\"w_MET\",1,3\)
root -l -q -b DataMCComp.C\($d,\"w_MET_sign\",1,3\)

root -l -q -b DataMCComp.C\($d,\"w_MET_b\",1,3\)
root -l -q -b DataMCComp.C\($d,\"w_MET_sign_b\",1,3\)
...
root -l -q -b DataMCComp.C\($d,\"w_first_bjet_eta\",1,3\)
root -l -q -b DataMCComp.C\($d,\"w_second_bjet_pt\",1,3\)
root -l -q -b DataMCComp.C\($d,\"w_second_bjet_eta\",1,3\)
root -l -q -b DataMCComp.C\($d,\"w_third_bjet_pt\",1,3\)
root -l -q -b DataMCComp.C\($d,\"w_third_bjet_eta\",1,3\)

root -l -q -b DataMCComp.C\($d,\"w_SVTX_mass_jet\",1,3\)
root -l -q -b DataMCComp.C\($d,\"w_SVTX_mass_trk\",1,3\)
root -l -q -b DataMCComp.C\($d,\"w_SVTX_mass\",1,3\)

root -l -q -b DataMCComp.C\($d,\"w_secondvtx_N\",1,3\)
root -l -q -b DataMCComp.C\($d,\"w_secondvtx_N_zoom\",1,3\)

root -l -q -b DataMCComp.C\($d,\"w_BJP\",1,3\)
root -l -q -b DataMCComp.C\($d,\"w_JBP\",1,3\)

root -l -q -b DataMCComp.C\($d,\"w_secondvtx_N_mass\",1,3\)

root -l -q -b DataMCComp.C\($d,\"w_secondvtx_N_nomass\",1,3\)

root -l -q -b DataMCComp.C\($d,\"w_BJP_mass\",1,3\)
root -l -q -b DataMCComp.C\($d,\"w_JBP_mass\",1,3\)

root -l -q -b DataMCComp.C\($d,\"w_BJP_nomass\",1,3\)
root -l -q -b DataMCComp.C\($d,\"w_JBP_nomass\",1,3\)

root -l -q -b DataMCComp.C\($d,\"w_BJP0\",1,3\)
root -l -q -b DataMCComp.C\($d,\"w_BJP1\",1,3\)
root -l -q -b DataMCComp.C\($d,\"w_BJP2\",1,3\)
...
while [ $i -le 2 ]; do
  ...
  root -l -q -b DataMCComp.C\($d,\"w_mass_ee_wide\",1,$i,0,2\)
  root -l -q -b DataMCComp.C\($d,\"w_mass_ee_b_wide\",1,$i,0,1\)

  root -l -q -b DataMCComp.C\($d,\"w_mass_mm_wide\",1,$i,0,2\)
  root -l -q -b DataMCComp.C\($d,\"w_mass_mm_b_wide\",1,$i,0,1\)
...
root -l -q -b DataMCComp.C\($d,\"w_MET_sign\",1,3,0,1\)
root -l -q -b DataMCComp.C\($d,\"w_MET_sign_b\",1,3,0,1\)

root -l -q -b DataMCComp.C\($d,\"w_mass_em_wide\",1,3,0,1\)
root -l -q -b DataMCComp.C\($d,\"w_mass_em_b_wide\",1,3,0,1\)
