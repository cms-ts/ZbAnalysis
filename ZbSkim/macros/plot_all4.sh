...
while [ $i -le 2 ]; do
  ...
  #root -l -q -b DataMCComp4.C+\($d,\"w_first_bjet_pt\",1,$i,0,3,$n\)
  #root -l -q -b DataMCComp4.C+\($d,\"w_first_bjet_eta\",1,$i,0,3,$n\)
  ...
  root -l -q -b DataMCComp4.C+\($d,\"w_pt_Z_mm_b\",1,$i,0,3,$n\)
...
while [ $i -le 2 ]; do
  ...
  #root -l -q -b DataMCComp4.C+\($d,\"w_first_bjet_pt\",1,$i,1,3,$n\)
  #root -l -q -b DataMCComp4.C+\($d,\"w_first_bjet_eta\",1,$i,1,3,$n\)
...
while [ $i -le 2 ]; do
  ...
  #root -l -q -b DataMCComp4.C+\($d,\"w_first_bjet_pt\",1,$i,2,3,$n\)
  #root -l -q -b DataMCComp4.C+\($d,\"w_first_bjet_eta\",1,$i,2,3,$n\)
...
while [ $i -le 2 ]; do
  ...
  #root -l -q -b DataMCComp4.C+\($d,\"w_first_bjet_pt\",1,$i,3,3,$n\)
  #root -l -q -b DataMCComp4.C+\($d,\"w_first_bjet_eta\",1,$i,3,3,$n\)
...
while [ $i -le 2 ]; do
  ...
  #root -l -q -b DataMCComp4.C+\($d,\"w_first_bjet_pt\",1,$i,4,3,$n\)
  #root -l -q -b DataMCComp4.C+\($d,\"w_first_bjet_eta\",1,$i,4,3,$n\)
  ...
  root -l -q -b DataMCComp4.C+\($d,\"w_mass_Zj_ee_b\",1,$i,0,$n\)
  root -l -q -b DataMCComp4.C+\($d,\"w_mass_Zj_mm_b\",1,$i,0,$n\)
...
while [ $i -le 2 ]; do
  ...
  #root -l -q -b DataMCComp2.C+\($d,\"w_first_bjet_pt\",1,$i,0,3,$n\)
  #root -l -q -b DataMCComp2.C+\($d,\"w_first_bjet_eta\",1,$i,0,3,$n\)
  root -l -q -b DataMCComp2.C+\($d,\"w_pt_Z_ee\",1,$i,0,1\)
  root -l -q -b DataMCComp2.C+\($d,\"w_pt_Z_mm\",1,$i,0,1\)
  root -l -q -b DataMCComp2.C+\($d,\"w_pt_Z_ee_b\",1,$i,0,1,1\)
  root -l -q -b DataMCComp2.C+\($d,\"w_pt_Z_mm_b\",1,$i,0,1,1\)
  ...
  root -l -q -b DataMCComp2.C+\($d,\"w_mass_Zj_ee_b\",1,$i,0,1,$n\)
  root -l -q -b DataMCComp2.C+\($d,\"w_mass_Zj_mm_b\",1,$i,0,1,$n\)
...
while [ $i -le 2 ]; do
  ...
  #root -l -q -b DataMCComp2.C+\($d,\"w_first_bjet_pt\",1,$i,1,3,$n\)
  #root -l -q -b DataMCComp2.C+\($d,\"w_first_bjet_eta\",1,$i,1,3,$n\)
  ...
  root -l -q -b DataMCComp2.C+\($d,\"w_Ht_b\",1,$i,1,1,$n\)
  ...
  root -l -q -b DataMCComp2.C+\($d,\"w_mass_Zj_ee_b\",1,$i,1,1,$n\)
  root -l -q -b DataMCComp2.C+\($d,\"w_mass_Zj_mm_b\",1,$i,1,1,$n\)
