...
while [ $i -le 2 ]; do
  ...
  root -l -q -b DataMCComp2.C+\($d,\"w_delta_phi_ee_b\",1,$i,0,1,1\)
  root -l -q -b DataMCComp2.C+\($d,\"w_delta_phi_mm_b\",1,$i,0,1,1\)
...
while [ $i -le 2 ]; do
  ...
  root -l -q -b DataMCComp2.C+\($d,\"w_delta_phi_ee_b\",1,$i,1,1,$n\)
  root -l -q -b DataMCComp2.C+\($d,\"w_delta_phi_mm_b\",1,$i,1,1,$n\)
