...
while [ $i -le 2 ]; do
  ...
  root -l -q -b DataMCComp4.C\($d,\"w_mass_zb\",1,$i\)
  root -l -q -b DataMCComp4.C\($d,\"w_mass_zj\",1,$i\)
...
while [ $i -le 2 ]; do
  ...
  root -l -q -b DataMCComp2.C\($d,\"w_mass_zb\",1,$i,0,1\)
  root -l -q -b DataMCComp2.C\($d,\"w_mass_zj\",1,$i,0,1\)
...
while [ $i -le 2 ]; do
  ...
  root -l -q -b DataMCComp2.C\($d,\"w_mass_zb\",1,$i,1,1\)
  root -l -q -b DataMCComp2.C\($d,\"w_mass_zj\",1,$i,1,1\)
