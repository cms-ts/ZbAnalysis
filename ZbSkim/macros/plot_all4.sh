...
while [ $i -le 2 ]; do
  ...
  root -l -q -b DataMCComp2.C+\($d,\"w_Phi_star_ee_b\",1,$i,0,1,$n\)
  root -l -q -b DataMCComp2.C+\($d,\"w_Phi_star_mm\",1,$i,0,1,$n\)
  root -l -q -b DataMCComp2.C+\($d,\"w_Phi_star_mm_b\",1,$i,0,1,$n\)
...
while [ $i -le 2 ]; do
  ...
  root -l -q -b DataMCComp2.C+\($d,\"w_delta_phi_2b\",1,$i,1,1,$n\)
  root -l -q -b DataMCComp2.C+\($d,\"w_DR_bb\",1,$i,1,1,$n\)
  root -l -q -b DataMCComp2.C+\($d,\"w_DR_eeb_min\",1,$i,1,1,$n\)
  root -l -q -b DataMCComp2.C+\($d,\"w_DR_eeb_max\",1,$i,1,1,$n\)
  root -l -q -b DataMCComp2.C+\($d,\"w_DR_mmb_min\",1,$i,1,1,$n\)
  root -l -q -b DataMCComp2.C+\($d,\"w_DR_mmb_max\",1,$i,1,1,$n\)
  root -l -q -b DataMCComp2.C+\($d,\"w_Phi_star_ee\",1,$i,1,1,$n\)
  root -l -q -b DataMCComp2.C+\($d,\"w_Phi_star_ee_b\",1,$i,1,1,$n\)
  root -l -q -b DataMCComp2.C+\($d,\"w_Phi_star_mm\",1,$i,1,1,$n\)
  root -l -q -b DataMCComp2.C+\($d,\"w_Phi_star_mm_b\",1,$i,1,1,$n\)
  root -l -q -b DataMCComp2.C+\($d,\"w_bb_mass\",1,$i,1,1,$n\)
  root -l -q -b DataMCComp2.C+\($d,\"w_eebb_mass\",1,$i,1,1,$n\)
  root -l -q -b DataMCComp2.C+\($d,\"w_mmbb_mass\",1,$i,1,1,$n\)
  root -l -q -b DataMCComp2.C+\($d,\"w_A_eeb\",1,$i,1,1,$n\)
  root -l -q -b DataMCComp2.C+\($d,\"w_A_mmb\",1,$i,1,1,$n\)
i=$((i+1))
done
