...
while [ $i -le 2 ]; do
  ...
  root -l -q -b DataMCComp4.C+\($d,\"w_Phi_star_ee_b\",1,$i,0,0,2\)
  root -l -q -b DataMCComp4.C+\($d,\"w_Phi_star_mm\",1,$i,0,0,$n\)
  root -l -q -b DataMCComp4.C+\($d,\"w_Phi_star_mm_b\",1,$i,0,0,2\)  
...
while [ $i -le 2 ]; do
  ...
  root -l -q -b DataMCComp4.C+\($d,\"w_Phi_star_ee_b\",1,$i,1,0,2\)
  root -l -q -b DataMCComp4.C+\($d,\"w_Phi_star_mm\",1,$i,1,0,$n\)
  root -l -q -b DataMCComp4.C+\($d,\"w_Phi_star_mm_b\",1,$i,1,0,2\)
...
while [ $i -le 2 ]; do
  ...
  root -l -q -b DataMCComp4.C+\($d,\"w_Phi_star_ee_b\",1,$i,2,0,2\)
  root -l -q -b DataMCComp4.C+\($d,\"w_Phi_star_mm\",1,$i,2,0,$n\)
  root -l -q -b DataMCComp4.C+\($d,\"w_Phi_star_mm_b\",1,$i,2,0,2\)
...
while [ $i -le 2 ]; do
  ...
  root -l -q -b DataMCComp4.C+\($d,\"w_Phi_star_ee_b\",1,$i,3,0,2\)
  root -l -q -b DataMCComp4.C+\($d,\"w_Phi_star_mm\",1,$i,3,0,$n\)
  root -l -q -b DataMCComp4.C+\($d,\"w_Phi_star_mm_b\",1,$i,3,0,2\)
...
while [ $i -le 2 ]; do
  ...
  root -l -q -b DataMCComp4.C+\($d,\"w_Phi_star_ee_b\",1,$i,4,0,2\)
  root -l -q -b DataMCComp4.C+\($d,\"w_Phi_star_mm\",1,$i,4,0,$n\)
  root -l -q -b DataMCComp4.C+\($d,\"w_Phi_star_mm_b\",1,$i,4,0,2\)
...
while [ $i -le 2 ]; do
  ...
  root -l -q -b DataMCComp2.C+\($d,\"w_mass_Zj_ee_b\",1,$i,0,1,1\)
  root -l -q -b DataMCComp2.C+\($d,\"w_mass_Zj_mm_b\",1,$i,0,1,1\)
  ...
  root -l -q -b DataMCComp2.C+\($d,\"w_Phi_star_ee_b\",1,$i,0,1,2\)
  root -l -q -b DataMCComp2.C+\($d,\"w_Phi_star_mm\",1,$i,0,1,$n\)
  root -l -q -b DataMCComp2.C+\($d,\"w_Phi_star_mm_b\",1,$i,0,1,2\)
...
while [ $i -le 2 ]; do
  ...
  root -l -q -b DataMCComp2.C+\($d,\"w_Phi_star_ee_b\",1,$i,1,1,2\)
  root -l -q -b DataMCComp2.C+\($d,\"w_Phi_star_mm\",1,$i,1,1,$n\)
  root -l -q -b DataMCComp2.C+\($d,\"w_Phi_star_mm_b\",1,$i,1,1,2\)
