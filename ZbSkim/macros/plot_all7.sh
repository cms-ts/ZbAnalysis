...
while [ $i -le 2 ]; do
  ...
  root -l -q -b DataMCComp7.C+\(\"w_y_Z_ee\",1,$i,0\)
  root -l -q -b DataMCComp7.C+\(\"w_y_Z_mm\",1,$i,0\)
  ...
  root -l -q -b DataMCComp7.C+\(\"w_mass_Zj_ee\",1,$i,0\)
  root -l -q -b DataMCComp7.C+\(\"w_mass_Zj_mm\",1,$i,0\)
...
while [ $i -le 2 ]; do
  ...
  root -l -q -b DataMCComp7.C+\(\"w_y_Z_ee\",1,$i,1\)
  root -l -q -b DataMCComp7.C+\(\"w_y_Z_mm\",1,$i,1\)
  ...
  root -l -q -b DataMCComp7.C+\(\"w_mass_Zj_ee\",1,$i,1\)
  root -l -q -b DataMCComp7.C+\(\"w_mass_Zj_mm\",1,$i,1\)
