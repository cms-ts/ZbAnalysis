...
while [ $i -le 2 ]; do
  ...
  root -l -q -b DataMCComp2.C\($d,\"w_mass_zb\",1,$i,0\)
  root -l -q -b DataMCComp2.C\($d,\"w_mass_zj\",1,$i,0\)
...
while [ $i -le 2 ]; do
  ...
  root -l -q -b DataMCComp2.C\($d,\"w_mass_zb\",1,$i,1\)
  root -l -q -b DataMCComp2.C\($d,\"w_mass_zj\",1,$i,1\)
