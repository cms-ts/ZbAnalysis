...
/*
    for (unsigned int i=0;i<jets.size();i++) {
      if ((fabs(jets[i].partonFlavour()) == 5 || fabs(jets[i].partonFlavour()) == 4)) {
        w0n = w0n * (1.0 - BtSFM_->Val(jets[i].pt(), jets[i].eta()));
      } else {
        if (fabs(jets[i].eta()<0.8))  w0n = w0n * (1.0 - LtSFe1_->Val(jets[i].pt(), jets[i].eta()));
        if ((jets[i].eta()>=-1.6 && jets[i].eta()<=-0.8) || (jets[i].eta()>=0.8 && jets[i].eta()<=1.6)) w0n = w0n * (1.0 - LtSFe2_->Val(jets[i].pt(), jets[i].eta()));
        if ((jets[i].eta()>=-2.4 && jets[i].eta()<-1.6) || (jets[i].eta()>1.6 && jets[i].eta()<=2.4)) w0n = w0n * (1.0 - LtSFe3_->Val(jets[i].pt(), jets[i].eta()));
      }
      double w=1.0;
      for (unsigned int j=0;j<jets.size();j++) {
        if (i!=j) {
          if ((fabs(jets[j].partonFlavour()) == 5 || fabs(jets[j].partonFlavour()) == 4)) {
            w = w * (1.0 - BtSFM_->Val(jets[j].pt(), jets[j].eta()));
          } else {
            if (fabs(jets[j].eta()<0.8)) w = w * (1.0 - LtSFe1_->Val(jets[j].pt(), jets[j].eta()));
            if ((jets[j].eta()>=-1.6 && jets[j].eta()<=-0.8) || (jets[j].eta()>=0.8 && jets[j].eta()<=1.6)) w = w * (1.0 - LtSFe2_->Val(jets[j].pt(), jets[j].eta()));
            if ((jets[j].eta()>=-2.4 && jets[j].eta()<-1.6) || (jets[j].eta()>1.6 && jets[j].eta()<=2.4)) w = w * (1.0 - LtSFe3_->Val(jets[j].pt(), jets[j].eta()));
          }
        }
      }
      if ((fabs(jets[i].partonFlavour()) == 5 || fabs(jets[i].partonFlavour()) == 4)) {
        w = w * BtSFM_->Val(jets[i].pt(), jets[i].eta());
      } else {
        if (fabs(jets[i].eta()<0.8))     w = w *   (LtSFe1_->Val(jets[i].pt(), jets[i].eta()));
        if ((jets[i].eta()>=-1.6 && jets[i].eta()<=-0.8) || (jets[i].eta()>=0.8 && jets[i].eta()<=1.6))     w = w *   (LtSFe2_->Val(jets[i].pt(), jets[i].eta()));
        if ((jets[i].eta()>=-2.4 && jets[i].eta()<-1.6) || (jets[i].eta()>1.6 && jets[i].eta()<=2.4))     w = w *   (LtSFe3_->Val(jets[i].pt(), jets[i].eta()));
      }
      w1n = w1n + w;
    }
*/
  ...
  TH1F*     c_DR_eeb_min;
  TH1F*     t_DR_eeb_min;
  TH1F*     bbSig_DR_eeb_min;
  TH1F*     w_DR_mmb_min;
  TH1F*     b_DR_mmb_min;
  TH1F*     c_DR_mmb_min;
  TH1F*     t_DR_mmb_min;
  TH1F*     bbSig_DR_mmb_min;
  TH1F*     w_DR_emb_min;
  TH1F*     b_DR_emb_min;
  TH1F*     c_DR_emb_min;
  TH1F*     t_DR_emb_min;
  TH1F*     bbSig_DR_emb_min;
  TH1F*     w_DR_eeb_max;
  TH1F*     b_DR_eeb_max;
  TH1F*     c_DR_eeb_max;
  TH1F*     t_DR_eeb_max;
  TH1F*     bbSig_DR_eeb_max;
  TH1F*     w_DR_mmb_max;
  TH1F*     b_DR_mmb_max;
  TH1F*     c_DR_mmb_max;
  TH1F*     t_DR_mmb_max;
  TH1F*     bbSig_DR_mmb_max;
  TH1F*     w_DR_emb_max;
  TH1F*     b_DR_emb_max;
  TH1F*     c_DR_emb_max;
  TH1F*     t_DR_emb_max;
  TH1F*     bbSig_DR_emb_max;
  TH1F*     w_A_eeb;  
  TH1F*     b_A_eeb;  
  TH1F*     c_A_eeb;  
  TH1F*     t_A_eeb;  
  ...
  TH1F*     c_eebb_mass;
  TH1F*     t_eebb_mass;
  TH1F*     bbSig_eebb_mass;
  TH1F*     w_eebb_mass_wide;
  TH1F*     b_eebb_mass_wide;
  TH1F*     c_eebb_mass_wide;
  TH1F*     t_eebb_mass_wide;
  TH1F*     w_mmbb_mass;
  TH1F*     b_mmbb_mass;
  TH1F*     c_mmbb_mass;
  TH1F*     t_mmbb_mass;
  TH1F*     bbSig_mmbb_mass;
  TH1F*     w_mmbb_mass_wide;
  TH1F*     b_mmbb_mass_wide;
  TH1F*     c_mmbb_mass_wide;
  TH1F*     t_mmbb_mass_wide;
  TH1F*     w_embb_mass;
  TH1F*     b_embb_mass;
  TH1F*     c_embb_mass;
  TH1F*     t_embb_mass;
  TH1F*     bbSig_embb_mass;
  TH1F*     w_embb_mass_wide;
  TH1F*     b_embb_mass_wide;
  TH1F*     c_embb_mass_wide;
  TH1F*     t_embb_mass_wide;
  TH1F*     w_eejj_mass;
  TH1F*     b_eejj_mass;
  TH1F*     c_eejj_mass;
  TH1F*     t_eejj_mass;
  ...
  TH1F*     bbSig_first_bjet_pt;
  
  TH1F*     w_first_bjet_pt_SVTX;	// leading b jet
  TH1F*     b_first_bjet_pt_SVTX;
  TH1F*     c_first_bjet_pt_SVTX;
  TH1F*     t_first_bjet_pt_SVTX;
...
ZbAnalyzer::ZbAnalyzer (const edm::ParameterSet & iConfig) {
  ...
  bbSig_delta_phi_2b =      fs->make < TH1F > ("bbSig_delta_phi_2b",    "bbSig_delta_phi_2b",   12, 0, TMath::Pi ());
  ...
  b_DR_bb =      fs->make < TH1F > ("b_DR_bb",    "b_DR_bb",   10, 0, 5);
  c_DR_bb =      fs->make < TH1F > ("c_DR_bb",    "c_DR_bb",   10, 0, 5);
  t_DR_bb =      fs->make < TH1F > ("t_DR_bb",    "t_DR_bb",   10, 0, 5);
  bbSig_DR_bb =  fs->make < TH1F > ("bbSig_DR_bb","bbSig_DR_bb",  10, 0, 5);
  ...
  bbSig_DR_eeb_min =     fs->make < TH1F > ("bbSig_DR_eeb_min",   "bbSig_DR_eeb_min; Delta_R",  15, 0., 4.);
  ...
  bbSig_DR_mmb_min =     fs->make < TH1F > ("bbSig_DR_mmb_min",   "bbSig_DR_mmb_min; Delta_R",  15, 0., 4.);
  ...
  bbSig_DR_emb_min =     fs->make < TH1F > ("bbSig_DR_emb_min",   "bbSig_DR_emb_min; Delta_R",  15, 0., 4.);
  ...
  bbSig_DR_eeb_max =     fs->make < TH1F > ("bbSig_DR_eeb_max",   "bbSig_DR_eeb_max; Delta_R",  15, 1.5, 5.);
  ...
  bbSig_DR_mmb_max =     fs->make < TH1F > ("bbSig_DR_mmb_max",   "bbSig_DR_mmb_max; Delta_R",  15, 1.5, 5.);
  ...
  bbSig_DR_emb_max =     fs->make < TH1F > ("bbSig_DR_emb_max",   "bbSig_DR_emb_max; Delta_R",  15, 1.5, 5.);
  ...
  bbSig_A_eeb =     fs->make < TH1F > ("bbSig_A_eeb",   "bbSig_A_eeb; A", 10, 0., 1.);
  ...
  bbSig_A_mmb =     fs->make < TH1F > ("bbSig_A_mmb",   "bbSig_A_mmb; A", 10, 0., 1.);
  ...
  bbSig_A_emb =     fs->make < TH1F > ("bbSig_A_emb",   "bbSig_A_emb; A", 10, 0., 1.);
  ...
  bbSig_bb_mass =     fs->make < TH1F > ("bbSig_bb_mass",   "bbSig_bb_mass;Mass [GeV]", 13, 30., 400);
  w_jj_mass =     fs->make < TH1F > ("w_jj_mass",   "w_jj_mass;Mass [GeV]", 20, 20., 1000);
  b_jj_mass =     fs->make < TH1F > ("b_jj_mass",   "b_jj_mass;Mass [GeV]", 20, 20., 1000);
  c_jj_mass =     fs->make < TH1F > ("c_jj_mass",   "c_jj_mass;Mass [GeV]", 20, 20., 1000);
  t_jj_mass =     fs->make < TH1F > ("t_jj_mass",   "t_jj_mass;Mass [GeV]", 20, 20., 1000);
  ...
  bbSig_eebb_mass =     fs->make < TH1F > ("bbSig_eebb_mass",   "bbSig_eebb_mass;Mass [GeV]", 12, 200., 500.);
  ...
  bbSig_mmbb_mass =     fs->make < TH1F > ("bbSig_mmbb_mass",   "bbSig_mmbb_mass;Mass [GeV]", 12, 200., 500.);
  ...
  bbSig_embb_mass =     fs->make < TH1F > ("bbSig_embb_mass",   "bbSig_embb_mass;Mass [GeV]", 12, 200., 500.);
  w_eebb_mass_wide =     fs->make < TH1F > ("w_eebb_mass_wide",   "w_eebb_mass_wide;Mass [GeV]", 20, 100., 1000.);
  b_eebb_mass_wide =     fs->make < TH1F > ("b_eebb_mass_wide",   "b_eebb_mass_wide;Mass [GeV]", 20, 100., 1000.);
  c_eebb_mass_wide =     fs->make < TH1F > ("c_eebb_mass_wide",   "c_eebb_mass_wide;Mass [GeV]", 20, 100., 1000.);
  t_eebb_mass_wide =     fs->make < TH1F > ("t_eebb_mass_wide",   "t_eebb_mass_wide;Mass [GeV]", 20, 100., 1000.);
  w_mmbb_mass_wide =     fs->make < TH1F > ("w_mmbb_mass_wide",   "w_mmbb_mass_wide;Mass [GeV]", 20, 100., 1000.);
  b_mmbb_mass_wide =     fs->make < TH1F > ("b_mmbb_mass_wide",   "b_mmbb_mass_wide;Mass [GeV]", 20, 100., 1000.);
  c_mmbb_mass_wide =     fs->make < TH1F > ("c_mmbb_mass_wide",   "c_mmbb_mass_wide;Mass [GeV]", 20, 100., 1000.);
  t_mmbb_mass_wide =     fs->make < TH1F > ("t_mmbb_mass_wide",   "t_mmbb_mass_wide;Mass [GeV]", 20, 100., 1000.);
  w_embb_mass_wide =     fs->make < TH1F > ("w_embb_mass_wide",   "w_embb_mass_wide;Mass [GeV]", 20, 100., 1000.);
  b_embb_mass_wide =     fs->make < TH1F > ("b_embb_mass_wide",   "b_embb_mass_wide;Mass [GeV]", 20, 100., 1000.);
  c_embb_mass_wide =     fs->make < TH1F > ("c_embb_mass_wide",   "c_embb_mass_wide;Mass [GeV]", 20, 100., 1000.);
  t_embb_mass_wide =     fs->make < TH1F > ("t_embb_mass_wide",   "t_embb_mass_wide;Mass [GeV]", 20, 100., 1000.);
  w_eejj_mass =     fs->make < TH1F > ("w_eejj_mass",   "w_eejj_mass;Mass [GeV]", 20, 100., 1000.);
  b_eejj_mass =     fs->make < TH1F > ("b_eejj_mass",   "b_eejj_mass;Mass [GeV]", 20, 100., 1000.);
  c_eejj_mass =     fs->make < TH1F > ("c_eejj_mass",   "c_eejj_mass;Mass [GeV]", 20, 100., 1000.);
  t_eejj_mass =     fs->make < TH1F > ("t_eejj_mass",   "t_eejj_mass;Mass [GeV]", 20, 100., 1000.);
  w_mmjj_mass =     fs->make < TH1F > ("w_mmjj_mass",   "w_mmjj_mass;Mass [GeV]", 20, 100., 1000.);
  b_mmjj_mass =     fs->make < TH1F > ("b_mmjj_mass",   "b_mmjj_mass;Mass [GeV]", 20, 100., 1000.);
  c_mmjj_mass =     fs->make < TH1F > ("c_mmjj_mass",   "c_mmjj_mass;Mass [GeV]", 20, 100., 1000.);
  t_mmjj_mass =     fs->make < TH1F > ("t_mmjj_mass",   "t_mmjj_mass;Mass [GeV]", 20, 100., 1000.);
  w_emjj_mass =     fs->make < TH1F > ("w_emjj_mass",   "w_emjj_mass;Mass [GeV]", 20, 100., 1000.);
  b_emjj_mass =     fs->make < TH1F > ("b_emjj_mass",   "b_emjj_mass;Mass [GeV]", 20, 100., 1000.);
  c_emjj_mass =     fs->make < TH1F > ("c_emjj_mass",   "c_emjj_mass;Mass [GeV]", 20, 100., 1000.);
  t_emjj_mass =     fs->make < TH1F > ("t_emjj_mass",   "t_emjj_mass;Mass [GeV]", 20, 100., 1000.);
  ...
  bbSig_first_bjet_pt =     fs->make < TH1F > ("bbSig_first_bjet_pt",    "bbSig_first_bjet_pt;P_t [GeV]", 50, 30., 700.);
  bbBkg_first_bjet_pt = fs->make < TH1F > ("bbBkg_first_bjet_pt","bbBkg_first_bjet_pt;P_t [GeV]", 50, 30., 700.); 

  w_first_bjet_pt_SVTX =     fs->make < TH1F > ("w_first_bjet_pt_SVTX",    "w_first_bjet_pt_SVTX;P_t [GeV]", 50, 30., 700.);
  b_first_bjet_pt_SVTX =     fs->make < TH1F > ("b_first_bjet_pt_SVTX",    "b_first_bjet_pt_SVTX;P_t [GeV]", 50, 30., 700.);
  c_first_bjet_pt_SVTX =     fs->make < TH1F > ("c_first_bjet_pt_SVTX",    "c_first_bjet_pt_SVTX;P_t [GeV]", 50, 30., 700.);
  t_first_bjet_pt_SVTX =     fs->make < TH1F > ("t_first_bjet_pt_SVTX",    "t_first_bjet_pt_SVTX;P_t [GeV]", 50, 30., 700.);
  ...
  bbSig_first_bjet_eta =fs->make < TH1F > ("bbSig_first_bjet_eta","bbSig_first_bjet_eta;Eta", 16, -2.5, 2.5);
  ...
  bbSig_first_bjet_eta_abs =fs->make < TH1F > ("bbSig_first_bjet_eta_abs","bbSig_first_bjet_eta_abs;abs(Eta)", 8, 0, 2.5);
  ...
  bbSig_second_bjet_pt =    fs->make < TH1F > ("bbSig_second_bjet_pt",   "bbSig_second_bjet_pt;P_t [GeV]", 50, 30., 500.);
  ...
  bbSig_second_bjet_eta =   fs->make < TH1F > ("bbSig_second_bjet_eta",  "bbSig_second_bjet_eta;Eta", 16, -2.5, 2.5);
  ...
  bbSig_second_bjet_eta_abs =   fs->make < TH1F > ("bbSig_second_bjet_eta_abs",  "bbSig_second_bjet_eta_abs;abs(Eta)", 8, 0, 2.5);
  ...
  w_delta_j_n =     fs->make < TH1F > ("w_delta_j_n",    "w_delta_j_n;[GeV]", 60, 60., 200.);
  b_delta_j_n =     fs->make < TH1F > ("b_delta_j_n",    "b_delta_j_n;[GeV]", 60, 60., 200.);
  c_delta_j_n =     fs->make < TH1F > ("c_delta_j_n",    "c_delta_j_n;[GeV]", 60, 60., 200.);
  t_delta_j_n =     fs->make < TH1F > ("t_delta_j_n",    "t_delta_j_n;[GeV]", 60, 60., 200.);
  ...
  bbSig_pt_Z_ee_b =     fs->make < TH1F > ("bbSig_pt_Z_ee_b",   "bbSig_pt_Z_ee_b;P_t [GeV]", 40, 0., 400.);
  ...
  bbSig_pt_Z_mm_b =     fs->make < TH1F > ("bbSig_pt_Z_mm_b",    "bbSig_pt_Z_mm_b;P_t [GeV]", 40, 0., 400.);
  ...
  bbSig_pt_Z_em_b =     fs->make < TH1F > ("bbSig_pt_Z_em_b",   "bbSig_pt_Z_em_b;P_t [GeV]", 40, 0., 400.);
  ...
  bbSig_SVTX_mass    =  fs->make < TH1F > ("bbSig_SVTX_mass",   "bbSig_SVTX_mass;Mass [GeV]", 50, 0, 6);
  ...
  bbSig_Ht_b =          fs->make < TH1F > ("bbSig_Ht_b",        "bbSig_Ht_b [GeV]", 50, 30., 1000.);
  ...
  w_MET_sign = 	        fs->make < TH1F > ("w_MET_sign",        "w_MET_sign;MET significance", 50, 0., 100.);
  b_MET_sign = 	        fs->make < TH1F > ("b_MET_sign",        "b_MET_sign;MET significance", 50, 0., 100.);
  c_MET_sign = 	        fs->make < TH1F > ("c_MET_sign",        "c_MET_sign;MET significance", 50, 0., 100.);
  t_MET_sign = 	        fs->make < TH1F > ("t_MET_sign",        "t_MET_sign;MET significance", 50, 0., 100.);
  ...
  w_MET_sign_b = 	fs->make < TH1F > ("w_MET_sign_b",    "w_MET_sign_b;MET significance", 50, 0., 100.);
  b_MET_sign_b = 	fs->make < TH1F > ("b_MET_sign_b",    "b_MET_sign_b;MET significance", 50, 0., 100.);
  c_MET_sign_b = 	fs->make < TH1F > ("c_MET_sign_b",    "c_MET_sign_b;MET significance", 50, 0., 100.);
  t_MET_sign_b = 	fs->make < TH1F > ("t_MET_sign_b",    "t_MET_sign_b;MET significance", 50, 0., 100.);
...
//    }
  ...
  if (Nj > 1) {
    math::XYZTLorentzVector jj = vect_jets[0].p4() + vect_jets[1].p4();
    jj_mass = jj.mass();
    if (ee_event) {
      math::XYZTLorentzVector eejj = jj + z_ee;
      eejj_mass = eejj.mass();
    }
    if (mm_event) {
      math::XYZTLorentzVector mmjj = jj + z_mm;
      mmjj_mass = mmjj.mass();
    }
    if (em_event) {
      math::XYZTLorentzVector emjj = jj + z_em;
      emjj_mass = emjj.mass();
    } 
  }
  if (Nb > 1) {
...
//	float w2b = 0.822508;
  ...
  if ((ee_event || mm_event || em_event) && Nj > 0 && vtx_cut) {
    ...
    if (Nb > 0 && met_cut && b_selection && nosvtx) {
      scalFac_b = btagSF(isMC, vect_bjets, 1);
      if (Nb == 1 && numB_ == 1)  scalFac_b = btagSF(isMC, vect_bjets, 1);
      if (Nb > 1 && numB_ == 2)  scalFac_b = btagSF(isMC, vect_bjets, 2);
      ...
      if (!ist && isMC && fabs(vect_bjets[0].partonFlavour()) == 5) {
        ...
        if (Nb > 1 && numB_ == 2 && fabs(vect_bjets[1].partonFlavour()) == 5) {
          bbSig_Ht_b->Fill (Ht, MyWeight*scalFac_b);
        }
  ...
  if (ee_event && Nj > 0 && vtx_cut) {
    ...
    w_eejj_mass->Fill (eejj_mass, MyWeight);
    ...
    if (ist) {
      ...
      t_eejj_mass->Fill (eejj_mass, MyWeight);
    }
    if (!ist && isMC && fabs(vect_jets[0].partonFlavour()) == 5) {
      ...
      b_eejj_mass->Fill (eejj_mass, MyWeight);
    }
    if (!ist && isMC && fabs(vect_jets[0].partonFlavour()) == 4) {
      ...
      c_eejj_mass->Fill (eejj_mass, MyWeight);
    }
    if (Nb > 0 && met_cut && b_selection && nosvtx) {
      scalFac_b = btagSF(isMC, vect_bjets, 1);
      if (Nb == 1 && numB_ == 1)  scalFac_b = btagSF(isMC, vect_bjets, 1);
	...
	b_y_Z_ee_b->Fill (diele_y, MyWeight*scalFac_b);
	  ...
	  bbBkg_pt_Z_ee_b->Fill (diele_pt, MyWeight*scalFac_b);
        ...
        if (Nb > 1 && numB_ == 2 && fabs(vect_bjets[1].partonFlavour()) == 5) {
          bbSig_pt_Z_ee_b->Fill (diele_pt, MyWeight*scalFac_b);
        }
	if (Nj == 1) {
  ...
  if (mm_event && Nj > 0 && vtx_cut) {
    ...
    w_mmjj_mass->Fill (mmjj_mass, MyWeight);
    ...
    if (ist) {
      ...
      t_mmjj_mass->Fill (mmjj_mass, MyWeight);
    }
    if (!ist && isMC && fabs(vect_jets[0].partonFlavour()) == 5) {
      ...
      b_mmjj_mass->Fill (mmjj_mass, MyWeight);
    }
    if (!ist && isMC && fabs(vect_jets[0].partonFlavour()) == 4) {
      ...
      c_mmjj_mass->Fill (mmjj_mass, MyWeight);
    }
    if (Nb > 0 && met_cut && b_selection && nosvtx) {
      scalFac_b = btagSF(isMC, vect_bjets, 1);
      if (Nb == 1 && numB_ == 1)  scalFac_b = btagSF(isMC, vect_bjets, 1);
	...
	b_y_Z_mm_b->Fill (dimuon_y, MyWeight*scalFac_b);
	  ...
	  bbBkg_y_Z_mm_b->Fill (dimuon_y, MyWeight*scalFac_b);
        ...
        if (Nb > 1 && numB_ == 2 && fabs(vect_bjets[1].partonFlavour()) == 5) {
          bbSig_pt_Z_mm_b->Fill (dimuon_pt, MyWeight*scalFac_b);
        }
        if (Nj == 1) {
  ...
  if (em_event && Nj > 0 && vtx_cut) {
    ...
    w_emjj_mass->Fill (emjj_mass, MyWeight);
    ...
    if (ist) {
      ...
      t_emjj_mass->Fill (emjj_mass, MyWeight);
    }
    if (!ist && isMC && fabs(vect_jets[0].partonFlavour()) == 5) {
      ...
      b_emjj_mass->Fill (emjj_mass, MyWeight);
    }
    if (!ist && isMC && fabs(vect_jets[0].partonFlavour()) == 4) {
      ...
      c_emjj_mass->Fill (emjj_mass, MyWeight);
    }
    if (Nb > 0 && met_cut && b_selection && nosvtx) {
      scalFac_b = btagSF(isMC, vect_bjets, 1);
      if (Nb == 1 && numB_ == 1)  scalFac_b = btagSF(isMC, vect_bjets, 1);
	...
	b_y_Z_em_b->Fill (dielemuon_y, MyWeight*scalFac_b);
	  ...
	  bbBkg_y_Z_em_b->Fill (dielemuon_y, MyWeight*scalFac_b);
        ...
        if (Nb > 1 && numB_ == 2 && fabs(vect_bjets[1].partonFlavour()) == 5) {
          bbSig_pt_Z_em_b->Fill (dielemuon_pt, MyWeight*scalFac_b);
        }
	if (Nj == 1) {
  ...
  if (ee_event && Nj > 0 && Nb > 0 && vtx_cut && met_cut && b_selection && nosvtx) {
    scalFac_b = btagSF(isMC, vect_bjets, 1);
    if (Nb == 1 && numB_ == 1)  scalFac_b = btagSF(isMC, vect_bjets, 1);
    if (Nb > 1 && numB_ == 2)  scalFac_b = btagSF(isMC, vect_bjets, 2);
  ...
  if (mm_event && Nj > 0 && Nb > 0 && vtx_cut && met_cut && b_selection && nosvtx) {
    scalFac_b = btagSF(isMC, vect_bjets, 1);
    if (Nb == 1 && numB_ == 1)  scalFac_b = btagSF(isMC, vect_bjets, 1);
    if (Nb > 1 && numB_ == 2)  scalFac_b = btagSF(isMC, vect_bjets, 2);
  ...
  if (em_event && Nj > 0 && Nb > 0 && vtx_cut && met_cut && b_selection && nosvtx) {
    scalFac_b = btagSF(isMC, vect_bjets, 1);
    if (Nb == 1 && numB_ == 1)  scalFac_b = btagSF(isMC, vect_bjets, 1);
    if (Nb > 1 && numB_ == 2)  scalFac_b = btagSF(isMC, vect_bjets, 2);
  ...
  if ((ee_event || mm_event || em_event) && Nj > 0 && Nb > 0 && vtx_cut && met_cut && b_selection && nosvtx) {
    ...
    if (!ist && isMC && fabs(vect_bjets[0].partonFlavour()) == 5) {
      ...
      if (Nb > 1 && numB_ == 2 && fabs(vect_bjets[1].partonFlavour()) == 5) {
        bbSig_SVTX_mass->Fill (sumVertexMass, MyWeight*scalFac_b);
      }
  ...
  if ((ee_event || mm_event || em_event) && Nj > 0 && vtx_cut) {
    ...
    w_jj_mass->Fill (jj_mass, MyWeight);
    if (ist) {
      ...
      t_jj_mass->Fill (jj_mass, MyWeight);
    }
    if (!ist && isMC && fabs(vect_jets[0].partonFlavour()) == 5) {
      ...
      b_jj_mass->Fill (jj_mass, MyWeight);
    }
    if (!ist && isMC && fabs(vect_jets[0].partonFlavour()) == 4) {
      ...
      c_jj_mass->Fill (jj_mass, MyWeight);
    }
  }
  ...
  if ((ee_event || mm_event || em_event) && Nj > 0 && Nb > 0 && vtx_cut && met_cut && b_selection && nosvtx) {
    ...
    if (nosvtx) {
      w_first_bjet_pt_SVTX->Fill (vect_bjets[0].pt(), MyWeight*scalFac_b);
    }
    ...
    if (ist) {
      ...
      if (nosvtx) {
        t_first_bjet_pt_SVTX->Fill (vect_bjets[0].pt(), MyWeight*scalFac_b);
      }
    ...
    if (!ist && isMC && fabs(vect_bjets[0].partonFlavour()) == 5) {
      if (Nb > 1) {
        ...
        if (Nb > 1 && numB_ == 2 && fabs(vect_bjets[1].partonFlavour()) == 5) {
          bbSig_delta_phi_2b->Fill (delta_phi_2b, MyWeight*scalFac_b);
          bbSig_DR_bb->Fill (DR_bb, MyWeight*scalFac_b);
        }
        b_Deta_bb->Fill(Deta_bb, MyWeight*scalFac_b);
      }
      if (nosvtx) {
        b_first_bjet_pt_SVTX->Fill (vect_bjets[0].pt(), MyWeight*scalFac_b);
      }
      ...
      if (Nb > 1 && numB_ == 2 && fabs(vect_bjets[1].partonFlavour()) == 5) {
        bbSig_first_bjet_pt->Fill (vect_bjets[0].pt(), MyWeight*scalFac_b);
        bbSig_first_bjet_eta->Fill (vect_bjets[0].eta(), MyWeight*scalFac_b);
        bbSig_first_bjet_eta_abs->Fill (fabs(vect_bjets[0].eta()), MyWeight*scalFac_b);
      }
      if (Nb == 1 && numB_ == 1 && findBjet(vect_jets, vect_bjets)) {
    ...
    if (!ist && isMC && fabs(vect_bjets[0].partonFlavour()) == 4) {
      ...
      if (nosvtx) {
        c_first_bjet_pt_SVTX->Fill (vect_bjets[0].pt(), MyWeight*scalFac_b);
      }
  ...
  if ((ee_event || mm_event || em_event) && Nj > 1 && Nb > 1 && vtx_cut && met_cut && b_selection && nosvtx) {
    scalFac_b = btagSF(isMC, vect_bjets, 2);
    ...
    if (!ist && isMC && fabs(vect_bjets[1].partonFlavour()) == 5) {
      ...
      if (numB_ == 2 && fabs(vect_bjets[0].partonFlavour()) == 5) {
        bbSig_second_bjet_pt->Fill (vect_bjets[1].pt(), MyWeight*scalFac_b);
        bbSig_second_bjet_eta->Fill (vect_bjets[1].eta(), MyWeight*scalFac_b);
        bbSig_second_bjet_eta_abs->Fill (fabs(vect_bjets[1].eta()), MyWeight*scalFac_b);
      }
  ...
  if ((ee_event || mm_event || em_event) && Nj > 2 && Nb > 2 && vtx_cut && met_cut && b_selection && nosvtx) {
  ...
  if ((ee_event || mm_event || em_event) && Nj == 1 && Nb > 0 && vtx_cut && met_cut && b_selection && nosvtx) {
    scalFac_b = btagSF(isMC, vect_bjets, 1);
    if (Nb == 1 && numB_ == 1)  scalFac_b = btagSF(isMC, vect_bjets, 1);
    if (Nb > 1 && numB_ == 2)  scalFac_b = btagSF(isMC, vect_bjets, 2);
  ...
  if ((ee_event || mm_event || em_event) && Nj > 0 && Nb > 1 && vtx_cut && met_cut && b_selection && nosvtx) {
    ...
    if (!ist && isMC && fabs(vect_bjets[0].partonFlavour()) == 5) {
      ...
      if (Nb > 1 && numB_ == 2 && fabs(vect_bjets[1].partonFlavour()) == 5) {
      bbSig_bb_mass->Fill (bb_mass, MyWeight*scalFac_b);
      }
    }
    if (!ist && isMC && fabs(vect_bjets[0].partonFlavour()) == 4) {
    ...
    if (ee_event) {
      ...
      w_eebb_mass_wide->Fill (eebb_mass, MyWeight*scalFac_b);
      if (ist) {
        ...
        t_eebb_mass_wide->Fill (eebb_mass, MyWeight*scalFac_b);
      } 
      if (!ist && isMC && fabs(vect_bjets[0].partonFlavour()) == 5) {
        ...
        b_eebb_mass_wide->Fill (eebb_mass, MyWeight*scalFac_b);
        if (Nb > 1 && numB_ == 2 && fabs(vect_bjets[1].partonFlavour()) == 5) {
          bbSig_DR_eeb_min->Fill (DR_eeb_min, MyWeight*scalFac_b);
          bbSig_DR_eeb_max->Fill (DR_eeb_max, MyWeight*scalFac_b);
          bbSig_A_eeb->Fill (A_eeb, MyWeight*scalFac_b);
          bbSig_eebb_mass->Fill (eebb_mass, MyWeight*scalFac_b);
        }
      }
      if (!ist && isMC && fabs(vect_bjets[0].partonFlavour()) == 4) {
        ...
        c_eebb_mass_wide->Fill (eebb_mass, MyWeight*scalFac_b);
      }
    }
    if (mm_event) {
      ...
      w_mmbb_mass_wide->Fill (mmbb_mass, MyWeight*scalFac_b);
      if (ist) {
        ...
        t_mmbb_mass_wide->Fill (mmbb_mass, MyWeight*scalFac_b);
      } 
      if (!ist && isMC && fabs(vect_bjets[0].partonFlavour()) == 5) {
        ...
        b_mmbb_mass_wide->Fill (mmbb_mass, MyWeight*scalFac_b);
        if (Nb > 1 && numB_ == 2 && fabs(vect_bjets[1].partonFlavour()) == 5) {
          bbSig_DR_mmb_min->Fill (DR_mmb_min, MyWeight*scalFac_b);
          bbSig_DR_mmb_max->Fill (DR_mmb_max, MyWeight*scalFac_b);
          bbSig_A_mmb->Fill (A_mmb, MyWeight*scalFac_b);
          bbSig_mmbb_mass->Fill (mmbb_mass, MyWeight*scalFac_b);
        }
      }
      if (!ist && isMC && fabs(vect_bjets[0].partonFlavour()) == 4) {
        ...
        c_mmbb_mass_wide->Fill (mmbb_mass, MyWeight*scalFac_b);
      }
    } 
    if (em_event) {
      ...
      w_embb_mass_wide->Fill (embb_mass, MyWeight*scalFac_b);
      if (ist) {
        ...
        t_embb_mass_wide->Fill (embb_mass, MyWeight*scalFac_b);
      } 
      if (!ist && isMC && fabs(vect_bjets[0].partonFlavour()) == 5) {
        ...
        b_embb_mass_wide->Fill (embb_mass, MyWeight*scalFac_b);
        if (Nb > 1 && numB_ == 2 && fabs(vect_bjets[1].partonFlavour()) == 5) {
          bbSig_DR_emb_min->Fill (DR_emb_min, MyWeight*scalFac_b);
          bbSig_DR_emb_max->Fill (DR_emb_max, MyWeight*scalFac_b);
          bbSig_A_emb->Fill (A_emb, MyWeight*scalFac_b);
          bbSig_embb_mass->Fill (embb_mass, MyWeight*scalFac_b);
        }
      }
      if (!ist && isMC && fabs(vect_bjets[0].partonFlavour()) == 4) {
        ...
        c_embb_mass_wide->Fill (embb_mass, MyWeight*scalFac_b);
      }
    } 	 	  	
  }
...
void ZbAnalyzer::beginJob () {
  ...
  BtSF_  = new table(path_ + "/" + "btag_eff.txt");   //btagging scale factors SFb = SFc CSVT
  BtSFM_  = new table(path_ + "/" + "btag_eff_med.txt");   //btagging scale factors SFb = SFc CSVM
  LtSF_  = new table(path_ + "/" + "light_eff.txt");  //light flavour scale factors CSVT
  LtSFe1_  = new table(path_ + "/" + "light_eff_eta1.txt");  //light flavour scale factors CSVM
  LtSFe2_  = new table(path_ + "/" + "light_eff_eta2.txt");  //light flavour scale factors CSVM
  LtSFe3_  = new table(path_ + "/" + "light_eff_eta3.txt");  //light flavour scale factors CSVM
