...
ZbAnalyzer::ZbAnalyzer (const edm::ParameterSet & iConfig) {
  ...
  b_DR_eeb_min =     fs->make < TH1F > ("b_DR_eeb_min",   "b_DR_eeb_min; Delta_R",  25, 0., 4.);  
  c_DR_eeb_min =     fs->make < TH1F > ("c_DR_eeb_min",   "c_DR_eeb_min; Delta_R",  25, 0., 4.);  
  t_DR_eeb_min =     fs->make < TH1F > ("t_DR_eeb_min",   "t_DR_eeb_min; Delta_R",  25, 0., 4.);  
  w_DR_mmb_min =     fs->make < TH1F > ("w_DR_mmb_min",   "w_DR_mmb_min; Delta_R",  25, 0., 4.);  
  b_DR_mmb_min =     fs->make < TH1F > ("b_DR_mmb_min",   "b_DR_mmb_min; Delta_R",  25, 0., 4.);  
  c_DR_mmb_min =     fs->make < TH1F > ("c_DR_mmb_min",   "c_DR_mmb_min; Delta_R",  25, 0., 4.);  
  t_DR_mmb_min =     fs->make < TH1F > ("t_DR_mmb_min",   "t_DR_mmb_min; Delta_R",  25, 0., 4.);  
  w_DR_emb_min =     fs->make < TH1F > ("w_DR_emb_min",   "w_DR_emb_min; Delta_R",  25, 0., 4.);  
  b_DR_emb_min =     fs->make < TH1F > ("b_DR_emb_min",   "b_DR_emb_min; Delta_R",  25, 0., 4.);  
  c_DR_emb_min =     fs->make < TH1F > ("c_DR_emb_min",   "c_DR_emb_min; Delta_R",  25, 0., 4.);  
  t_DR_emb_min =     fs->make < TH1F > ("t_DR_emb_min",   "t_DR_emb_min; Delta_R",  25, 0., 4.);  
  w_DR_eeb_max =     fs->make < TH1F > ("w_DR_eeb_max",   "w_DR_eeb_max; Delta_R",  25, 1.5, 5.);  
  b_DR_eeb_max =     fs->make < TH1F > ("b_DR_eeb_max",   "b_DR_eeb_max; Delta_R",  25, 1.5, 5.);  
  c_DR_eeb_max =     fs->make < TH1F > ("c_DR_eeb_max",   "c_DR_eeb_max; Delta_R",  25, 1.5, 5.);  
  t_DR_eeb_max =     fs->make < TH1F > ("t_DR_eeb_max",   "t_DR_eeb_max; Delta_R",  25, 1.5, 5.);  
  w_DR_mmb_max =     fs->make < TH1F > ("w_DR_mmb_max",   "w_DR_mmb_max; Delta_R",  25, 1.5, 5.);  
  b_DR_mmb_max =     fs->make < TH1F > ("b_DR_mmb_max",   "b_DR_mmb_max; Delta_R",  25, 1.5, 5.);  
  c_DR_mmb_max =     fs->make < TH1F > ("c_DR_mmb_max",   "c_DR_mmb_max; Delta_R",  25, 1.5, 5.);  
  t_DR_mmb_max =     fs->make < TH1F > ("t_DR_mmb_max",   "t_DR_mmb_max; Delta_R",  25, 1.5, 5.);  
  w_DR_emb_max =     fs->make < TH1F > ("w_DR_emb_max",   "w_DR_emb_max; Delta_R",  25, 1.5, 5.);  
  b_DR_emb_max =     fs->make < TH1F > ("b_DR_emb_max",   "b_DR_emb_max; Delta_R",  25, 1.5, 5.);  
  c_DR_emb_max =     fs->make < TH1F > ("c_DR_emb_max",   "c_DR_emb_max; Delta_R",  25, 1.5, 5.);  
  t_DR_emb_max =     fs->make < TH1F > ("t_DR_emb_max",   "t_DR_emb_max; Delta_R",  25, 1.5, 5.);  
